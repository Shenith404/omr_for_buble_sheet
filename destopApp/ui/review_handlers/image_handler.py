...
class ReviewImageHandler:
    """Handles image operations for the Review Tab"""
    ...
    @staticmethod
    def update_image_list_widget(images_list, filtered_image_paths, is_reviewed_callback):
    ...
    def show_no_images_message(image_label, message_type="no_project"):
        ...
        if message_type == "no_project":
            ...
            image_label.setText("No marked images available in results folder")
        else:
