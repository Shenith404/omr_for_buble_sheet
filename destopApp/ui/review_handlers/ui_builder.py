"""
UI Builder for Review Tab
Handles all UI setup and styling for the review tab
"""
...
class ReviewUIBuilder:
    """Handles UI creation and styling for the Review Tab"""
    
    @staticmethod
    def get_main_stylesheet():
        """Return the main stylesheet for the review tab"""
        return """
            QWidget {
    ...
    def create_search_and_filter_widgets():
        ...
        filter_combo.addItems(["All Images", "Reviewed Only", "Unreviewed Only"])
    ...
    def create_action_buttons():
        """Create action buttons (Change Answer and Mark as Reviewed)"""
